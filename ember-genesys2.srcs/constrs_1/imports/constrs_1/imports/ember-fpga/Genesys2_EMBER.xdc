...
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS33} [get_ports mclk_pause_led]
...
#set_property -dict { PACKAGE_PIN U23   IOSTANDARD LVCMOS33 } [get_ports { miso }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jb_n[4]
...
set_property -dict { PACKAGE_PIN AG30  IOSTANDARD LVCMOS33 } [get_ports { mosi_in }]; #IO_L18P_T2_13 Sch=jc[8]
set_property -dict { PACKAGE_PIN AK30  IOSTANDARD LVCMOS33 } [get_ports { miso }]; #IO_L15N_T2_DQS_13 Sch=jc[9]
set_property -dict { PACKAGE_PIN AK28  IOSTANDARD LVCMOS33 } [get_ports { sclk_in }]; #IO_L20N_T3_13 Sch=jc[10]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {sclk_in_IBUF}]

## PMOD Header JD
set_property -dict { PACKAGE_PIN V27   IOSTANDARD LVCMOS33 } [get_ports { trig_in_ack }]; #IO_L16N_T2_A15_D31_14 Sch=jd[1]
...
create_clock -period 200.000 -name sclk_in -waveform {0.000 100.000} [get_ports sclk_in]

create_clock -period 10.000 -name VIRTUAL_clk_out1_ember_fpga_clk_wiz_0 -waveform {0.000 5.000}
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_ember_fpga_clk_wiz_0] -min -add_delay 1.000 [get_ports {sa_do[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_ember_fpga_clk_wiz_0] -max -add_delay 2.000 [get_ports {sa_do[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_ember_fpga_clk_wiz_0] -min -add_delay 1.000 [get_ports sa_rdy]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_ember_fpga_clk_wiz_0] -max -add_delay 2.000 [get_ports sa_rdy]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_ember_fpga_clk_wiz_0] -min -add_delay 0.000 [get_ports use_mmcm]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_ember_fpga_clk_wiz_0] -max -add_delay 2.000 [get_ports use_mmcm]

set_false_path -from [get_ports reset]
set_false_path -from [get_ports use_mmcm]
set_false_path -to [get_ports mclk_pause_led]
set_false_path -to [get_ports rst_n_led]
set_false_path -to [get_ports use_mmcm_led]
set_false_path -to [get_ports reset_led]
set_false_path -to [get_ports rram_busy_ember_led]
set_false_path -to [get_ports sclk_led]
set_false_path -to [get_ports sc_led]
set_false_path -to [get_ports mosi_led]
set_false_path -to [get_ports rst_n_out]
set_false_path -to [get_ports trig_in_ack]
