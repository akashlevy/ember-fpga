...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clkmux_0_sclk_out [get_bd_ports sa_clk] [get_bd_ports sclk_led] [get_bd_ports sclk_out] [get_bd_pins clkmux_0/clk_out] [get_bd_pins rram_top_wrapper_0/sclk]
