...
namespace eval ::optrace {
  variable script "/sim2/akashl/ember-fpga/ember-genesys2.runs/ember_fpga_addr_loop_counter_0_0_synth_1/ember_fpga_addr_loop_counter_0_0.tcl"
...
OPTRACE "ember_fpga_addr_loop_counter_0_0_synth_1" START { ROLLUP_AUTO }
...
read_verilog -library xil_defaultlib /sim2/akashl/ember-fpga/ember-genesys2.srcs/sources_1/new/addr_loop_counter.v
read_ip -quiet /sim2/akashl/ember-fpga/ember-genesys2.srcs/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir /sim2/akashl/ember-fpga/ember-genesys2.runs/ember_fpga_addr_loop_counter_0_0_synth_1 -new_name ember_fpga_addr_loop_counter_0_0 -ip [get_ips ember_fpga_addr_loop_counter_0_0]]
...
synth_design -top ember_fpga_addr_loop_counter_0_0 -part xc7k325tffg900-2 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix ember_fpga_addr_loop_counter_0_0_ ember_fpga_addr_loop_counter_0_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ember_fpga_addr_loop_counter_0_0_stub.v
 lappend ipCachedFiles ember_fpga_addr_loop_counter_0_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ember_fpga_addr_loop_counter_0_0_stub.vhdl
 lappend ipCachedFiles ember_fpga_addr_loop_counter_0_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ember_fpga_addr_loop_counter_0_0_sim_netlist.v
 lappend ipCachedFiles ember_fpga_addr_loop_counter_0_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ember_fpga_addr_loop_counter_0_0_sim_netlist.vhdl
 lappend ipCachedFiles ember_fpga_addr_loop_counter_0_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp ember_fpga_addr_loop_counter_0_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips ember_fpga_addr_loop_counter_0_0]
 }
...
rename_ref -prefix_all ember_fpga_addr_loop_counter_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef ember_fpga_addr_loop_counter_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "ember_fpga_addr_loop_counter_0_0_synth_1_synth_report_utilization_0" "report_utilization -file ember_fpga_addr_loop_counter_0_0_utilization_synth.rpt -pb ember_fpga_addr_loop_counter_0_0_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force /sim2/akashl/ember-fpga/ember-genesys2.runs/ember_fpga_addr_loop_counter_0_0_synth_1/ember_fpga_addr_loop_counter_0_0.dcp /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /sim2/akashl/ember-fpga/ember-genesys2.runs/ember_fpga_addr_loop_counter_0_0_synth_1/ember_fpga_addr_loop_counter_0_0_stub.v /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /sim2/akashl/ember-fpga/ember-genesys2.runs/ember_fpga_addr_loop_counter_0_0_synth_1/ember_fpga_addr_loop_counter_0_0_stub.vhdl /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /sim2/akashl/ember-fpga/ember-genesys2.runs/ember_fpga_addr_loop_counter_0_0_synth_1/ember_fpga_addr_loop_counter_0_0_sim_netlist.v /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /sim2/akashl/ember-fpga/ember-genesys2.runs/ember_fpga_addr_loop_counter_0_0_synth_1/ember_fpga_addr_loop_counter_0_0_sim_netlist.vhdl /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /sim2/akashl/ember-fpga/ember-genesys2.ip_user_files/ip/ember_fpga_addr_loop_counter_0_0]} {
  catch { 
    file copy -force /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_stub.v /sim2/akashl/ember-fpga/ember-genesys2.ip_user_files/ip/ember_fpga_addr_loop_counter_0_0
  }
}

if {[file isdir /sim2/akashl/ember-fpga/ember-genesys2.ip_user_files/ip/ember_fpga_addr_loop_counter_0_0]} {
  catch { 
    file copy -force /sim2/akashl/ember-fpga/ember-genesys2.gen/sources_1/bd/ember_fpga/ip/ember_fpga_addr_loop_counter_0_0/ember_fpga_addr_loop_counter_0_0_stub.vhdl /sim2/akashl/ember-fpga/ember-genesys2.ip_user_files/ip/ember_fpga_addr_loop_counter_0_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "ember_fpga_addr_loop_counter_0_0_synth_1" END { }
