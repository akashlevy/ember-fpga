...
namespace eval ::optrace {
  variable script "/sim2/akashl/ember-fpga/ember-genesys2.runs/synth_1/ember_fpga_wrapper.tcl"
...
set_property used_in_implementation false [get_files /sim2/akashl/ember-fpga/ember-genesys2.srcs/constrs_1/imports/constrs_1/imports/ember-fpga/Genesys2_EMBER.xdc]
...
synth_design -top ember_fpga_wrapper -part xc7k325tffg900-2 -directive PerformanceOptimized -fsm_extraction one_hot -keep_equivalent_registers -resource_sharing off -no_lc -shreg_min_size 5
...
write_checkpoint -force -noxdef ember_fpga_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file ember_fpga_wrapper_utilization_synth.rpt -pb ember_fpga_wrapper_utilization_synth.pb"
